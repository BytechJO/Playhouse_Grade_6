function buildFillInBody(aObj) {
  ...
  if (typeof aObj != undefined && aObj != null) {
    ...
    for (x = 0; x < numOfQuestions; x++) {
      ...
      htmlStmt +=
        '<div class="' + que + ' img_fillin_gr" data-qno="' + (x + 1) + '">';
      ...
      if (tmpObj.singleword) {
        ...
        qStr = words
          ...
          .join(
            '<input class="text_input_area" type="text" maxlength="1" data-type="' +
              tmpObj.type +
              '">',
          );
      }
      ...
      htmlStmt +=
        '<input class="text_input_area" type="text" maxlength="200" data-type="" style="color: black;"></input>';
    }
    htmlStmt += "</div>";
