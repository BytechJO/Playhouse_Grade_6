...
function buildSubFooter(aObj, aVal) {
  ...
  if (
    ...
    var functionButtons =
      Array.isArray(aObj.functionbuttons)
        ? aObj.functionbuttons
        : [];

    for (
      var ff = 0;
      ff < functionButtons.length;
      ff++
    ) {
      tsubBtn = String(
        functionButtons[ff] || ""
...
function buildWorkBookPagesSidebar() {
  ...
  var sStmt =
    '<div class="workBookPagesSidebar" id="workBookPagesSidebar">';

  sStmt +=
    '<div class="workBookPagesSidebarHeader">';
  ...
  sStmt +=
    '<div class="workBookPagesSidebarList">';
  ...
  $(document)
    ...
    .on(
      ...
      function (event) {
        ...
        $("#workBookPagesSidebar")
          .addClass("open");

        $("#workBookPagesSidebarOverlay")
          .addClass("show");
      }
    );
...
function buildCoreFrame(ob) {
  ...
  */
  ...
  if (
    typeof buildTemplatePath === "function"
  ) {
  ...
  */
  ...
  if (!ob) {
    console.warn(
      "buildCoreFrame: object is missing"
    );
  ...
  */
  ...
  if (
    ...
    console.warn(
      "buildCoreFrame: _data is missing"
    );
