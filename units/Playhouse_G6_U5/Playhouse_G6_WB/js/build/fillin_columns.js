	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		for (x = 0; x < numOfRows; x++) {
			...
			for (y = 0; y < numInRowArray[x].length; y++) {
				...
				queClass = ((aObj.questions)[currentQue - 1]).hasAnswer ? "que" : "";
				htmlStmt += '<div class="' + queClass + ' ' + className + ' que_' + currentQue + ' h-100 d-flex flex-wrap" data-qno="' + (currentQue) + '">';
				htmlStmt += '<div class="q_order">'+currentQue+'</div>';
