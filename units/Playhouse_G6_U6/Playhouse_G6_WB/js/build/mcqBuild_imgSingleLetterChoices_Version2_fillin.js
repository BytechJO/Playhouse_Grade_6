  ...
  if (aObj != undefined && aObj != null) {
    ...
    for (var x = 0; x < numOfQuestions; x++) {
      ...
      // for (var y = 0; y < options.length; y++) {
        ...
        htmlStmt += '<span>' + tpOb.questionL + '</span>';
        htmlStmt += '&nbsp; (';
        htmlStmt += '<div id="pick_' + (x + 1) + '_' + (0 + 1) + '" class="mcq_1_5_q_group pick">';
        htmlStmt += '<div class="txt_box d-flex justify-content-center align-items-center" data - type="text" >';
        htmlStmt += '<span>' + options[0].text + '</span>';
        htmlStmt += '</div>';
        htmlStmt += '</div>';
        htmlStmt += '/';
        htmlStmt += '<div id="pick_' + (x + 1) + '_' + (1 + 1) + '" class="mcq_1_5_q_group pick">';
        htmlStmt += '<div class="txt_box d-flex justify-content-center align-items-center" data - type="text" >';
        htmlStmt += '<span>' + options[1].text + '</span>';
        htmlStmt += '</div>';
        htmlStmt += '</div>';
        htmlStmt += ') &nbsp;';
        htmlStmt += '<span>' + tpOb.questionR + '</span>';
      // }
