    ...
    for (var slideIndex = 0; slideIndex < aObj.slides.length; slideIndex++) {
      ...
      if (slide.layout == "text_on_image") {
        ...
        if (slide.grid_main_title != undefined && slide.grid_main_title != "") {
          ...
          slideHtml +=
            "<img src='" +
            slide.grid_main_title +
            "' class='grid_main_title_img'/>";
          slideHtml +=
            "<div class='snap_card audioIcon grid_main_title_text' data-slideNum='" +
            Number(slideIndex + 1) +
            "' data-audio='" +
        ...
        slideHtml += "</div>";
      } else if (slide.layout == "four_boxes_with_center_images") {
        slideHtml +=
          "<div class='four_boxes_layout " + slide.parent_class_name + "'>";

        // TITLE
        if (slide.titleText) {
          slideHtml +=
            "<div class='inventions_title'>" + slide.titleText + "</div>";
        }

        // TOP LEFT
        slideHtml += "<div class='invention_box invention_box_1'>";

        slideHtml += "<img src='" + slide.boxImages[0] + "'>";

        slideHtml += "</div>";

        // TOP RIGHT
        slideHtml += "<div class='invention_box invention_box_2'>";

        slideHtml += "<img src='" + slide.boxImages[1] + "'>";

        slideHtml += "</div>";

        // CENTER IMAGE 1
        if (slide.centerImages && slide.centerImages[0]) {
          slideHtml +=
            "<div class='center_invention_image center_invention_image_1'>";

          slideHtml += "<img src='" + slide.centerImages[0] + "'>";

          slideHtml += "</div>";
        }

        // BOTTOM LEFT
        slideHtml += "<div class='invention_box invention_box_3'>";

        slideHtml += "<img src='" + slide.boxImages[2] + "'>";

        slideHtml += "</div>";

        // BOTTOM RIGHT
        slideHtml += "<div class='invention_box invention_box_4'>";

        slideHtml += "<img src='" + slide.boxImages[3] + "'>";

        slideHtml += "</div>";

        // CENTER IMAGE 2
        if (slide.centerImages && slide.centerImages[1]) {
          slideHtml +=
            "<div class='center_invention_image center_invention_image_2'>";

          slideHtml += "<img src='" + slide.centerImages[1] + "'>";
