...
var mcq_data = {
  ...
  subTitleTextLeft:
    "<span class='title-order'>1</span> Circle it! Read each sentence. Circle the correct verb form (simple present or present continuous) to make the sentence correct. Write ‘S‘ for simple present sentences and ‘C‘ for present continuous sentences in the blank",
  subTitleTextRight: "",
  subTitleIcons: [""],
  subTitleAudio:
    "../audios/P31/1_Circle_it!_Read_each_sentence_Circle_the_correct_verb_form_(simple_present_or_present_continuous.mp3",
  activityheading: "",
  ...
  questions: [
    {
      questionL: "Sherry",
      questionR: "to the clothes shop right now.",
      answer: [2],
      audio: "",
    ...
    {
      questionL: "At 3:00 Tom",
      questionR: "his best friend.",
      answer: [1],
      audio: "",
      audioenable: "default", // correct (or) default
      fillinanswer: "S",
    ...
    {
      questionL: "We always",
      questionR: "horses at our grandparents’ house.",
      answer: [1],
      audio: "",
      audioenable: "default", // correct (or) default
      fillinanswer: "S",
    ...
    {
      questionL: "Sarah’s brother often",
      questionR: "at the weekend.",
      answer: [1],
      audio: "",
      audioenable: "default", // correct (or) default
      fillinanswer: "S",
    ...
    {
      questionL: "Today Aaron",
      questionR: "tennis with Brian.",
      answer: [2],
      audio: "",
      audioenable: "default", // correct (or) default
      fillinanswer: "C",
    ...
    {
      questionL: "Meg",
      questionR: "the dishes every day after school.",
      answer: [1],
      audio: "",
      audioenable: "default", // correct (or) default
      fillinanswer: "S",
