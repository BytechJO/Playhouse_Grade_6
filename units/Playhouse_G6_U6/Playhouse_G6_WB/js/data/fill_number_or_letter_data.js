...
var fillin_data = {
  ...
  subTitleTextLeft:
    '<span class="blue_text">1</span> Match it! Match the Word Power word to its picture.',
  subTitleTextRight: "",
  subTitleIcons: [""],
  subTitleAudio:
    "../audios/P29/1_Match_it!_Match_the_Word_Power_word_to_its_picture.mp3",
  defaultAnswer: 3,
  leftList: "",
