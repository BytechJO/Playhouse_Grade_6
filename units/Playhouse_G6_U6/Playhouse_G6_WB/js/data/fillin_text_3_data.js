...
var fillin_data = {
  ...
  subTitleTextLeft:
    '<span class="blue_text">2</span> Finish it! Fill in the blanks to complete the story using either the simple present or the present continuous form of the verb in brackets.',
  subTitleTextRight: "",
  subTitleIcons: [],
  subTitleAudio:
    "../audios/P31/2_Finish_it!_Fill_in_the_blanks_to_complete_the_story_using_either_the_simple_present_or_the_present.mp3",
  image: "",
