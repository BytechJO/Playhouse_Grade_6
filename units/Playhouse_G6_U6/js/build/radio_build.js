function buildStereo(stereo_data) {
  ...
  if (stereo_data.exist == true) {
    ...
    slideHtml +=
      '<div class="top" style="background:linear-gradient(90deg, rgba(' +
      (red + 40) +
      "," +
      (green + 40) +
      "," +
    ...
    slideHtml += "</div>";
    slideHtml +=
      '<div class="right" style="background: rgba(' +
      red +
      "," +
      (green - 40) +
      "," +
    ...
    slideHtml +=
      '<div class="player d-flex flex-column" style="background:linear-gradient(90deg, rgba(' +
      (red + 40) +
      "," +
      (green + 40) +
      "," +
    ...
    slideHtml +=
      '<div class="front_face" style="background: rgba(' +
      red +
      "," +
      green +
      "," +
      ...
      ')"></div>';
    slideHtml +=
      '<div class="right_face" style="background: rgba(' +
      red +
      "," +
      (green - 40) +
      "," +
    ...
    slideHtml +=
      '<div class="top_face" style="background:linear-gradient(90deg, rgba(' +
      (red + 40) +
      "," +
      (green + 40) +
      "," +
      ...
      ') 75%)"></div>'; //********* */
    slideHtml +=
      '<div class="front_face" style="background:linear-gradient(90deg, rgba(' +
      (red + 40) +
      "," +
      (green + 40) +
      "," +
...
function make_change_when_audio_play(audioElement) {
  ...
  audioElement.addEventListener("timeupdate", function () {
    ...
    for (let currentSent = 0; currentSent < targetTime.length; currentSent++) {
      if (
        currentTime >= targetTime[currentSent][0] &&
        currentTime <= targetTime[currentSent][1]
      ) {
        if (stereo_data.type == "phonics") {
          ...
          if (currentTime >= 0 && currentTime < 26) {
