var snapshot_data = {
  "snapshot": [{
      "audio": ["../audios/p48/pizza.mp3","../audios/p48/dough.mp3","../audios/p48/sauce.mp3","../audios/p48/sprinkle.mp3","../audios/p48/cheese.mp3","../audios/p48/add.mp3","../audios/p48/pepperoni.mp3","../audios/p48/slice.mp3"],
...
var Popups_data = {
  "slides": [
    {
      ...
      //   "audio": ["../audios/p48/pizza.mp3"]},
      // 'ccss': {
      //   "text": ["<span>1 Goodbye!</span>","<span>2 How are you?</span>","<span>3 Fine, thank you.</span>","<span>4 Hello!</span>","<span>5 Good morning!</span>"],
      //   "audio": ["../audios/p48/Pg4_Vocabulary_Adult Lady.mp3","../audios/p48/dough.mp3", "../audios/p48/pizza.mp3","../audios/p48/dough.mp3", "../audios/p48/pizza.mp3"]},
      'listen': {
        ...
        "titleIcons" : [""],
        "titlesAudio" : ["../audios/p48/Pg4_1.2_Adult_Lady.mp3","../audios/p48/Pg4_1.3_Adult Lady.mp3", "../audios/p48/Pg4_1.4_Adult Lady.mp3"],
        ...
        "words": ["1 headphones","2 flash drive", "3 mouse","4 keyboard","5 webcam", "6 scanner","7 printer","8 tablet PC", "9 laptop","10 speakers", "11 monitor", "12 desktop PC"],
        "audio": ["../audios/p48/1_headphones.mp3","../audios/p48/2_flash_drive.mp3", "../audios/p48/3_mouse.mp3",
                  "../audios/p48/4_keyboard.mp3","../audios/p48/5_webcam.mp3", "../audios/p48/6_scanner.mp3",
                  "../audios/p48/7_printer.mp3","../audios/p48/8_tablet_PC.mp3", "../audios/p48/9_laptop.mp3",
                  "../audios/p48/10_speakers.mp3","../audios/p48/11_monitor.mp3", "../audios/p48/12_desktop_PC.mp3"]},
      'listen2': {
        ...
        "audio": ["../audios/p48/Pg5_2.2_Adult Lady.mp3","../audios/p48/Pg5_2.3_Adult Lady.mp3"]},
        'listen3': {
          // "leftImage": "../images/pages/snapshots/page-2/popup-2-left-img.png",
          "mainTitle": "../images/pages/page-1/1-title.png",
          "mainTitle_audio" : "../audios/p48/WORD_POWER.mp3",
          "titleTexts" : ["<span class='title-order'>1</span> Listen and say."],
          "titleIcons" : [""],
          "titleTextRight": "<span class='blue_text'>Do you use a computer at home? How important are computers these days? How have computers helped people?</span>",
          "titlesAudio" : ["../audios/p48/1_Listen_and_say.mp3"],
          "image": [],
          "audio": ["../audios/p48/Pg5_2.2_Adult Lady.mp3","../audios/p48/Pg5_2.3_Adult Lady.mp3"]},
    },
  ],
  "class_name":["","","","","","","","","","","",""], //flex-row (or) flex-reverse (or) flex-column-reverse for each image-container **optional**
  "words"  : ["headphones","flash drive", "mouse","keyboard","webcam", "scanner","printer","tablet PC", "laptop","speakers", "monitor", "desktop PC"],
 ...
 "postions"  : ["left:349px; top:162px;",
                "left:356px; top:255px;",
                "left:351px; top:381px;",
                "left:350px; top:449px;",
                "left:351px; top:517px;",
                "left:324px; top:594px;",
                "left:350px; top:677px;",
                "left:619px; top:177px;",
                "left:769px; top:303px;",
                "left:701px; top:376px;",
                // "left:508px; top:475px;",
                // "left:369px; top:569px;",
              ],
  "imagesAudio" :["../audios/p48/1_headphones.mp3","../audios/p48/2_flash_drive.mp3", "../audios/p48/3_mouse.mp3",
                  "../audios/p48/4_keyboard.mp3","../audios/p48/5_webcam.mp3", "../audios/p48/6_scanner.mp3",
                  "../audios/p48/7_printer.mp3","../audios/p48/8_tablet_PC.mp3", "../audios/p48/9_laptop.mp3",
                  "../audios/p48/10_speakers.mp3","../audios/p48/11_monitor.mp3", "../audios/p48/12_desktop_PC.mp3"
            ],
