  ...
  if (aObj != undefined && aObj != null) {
    ...
    if (layOut == 1) {
      ...
      for (x = 0; x < numOfQuestions; x++) {
        ...
        htmlStmt +=
          '<div class="que fill_fields d-flex" data-qno="' + (x + 1) + '">';
        ...
        if (tmpObj.audio != "no") {
          ...
          htmlStmt +=
            '<div class="audioIcon off d-flex contant min_w_fit_contant" data-audio="' +
            tmpObj.audio +
            '">';
        } else {
          htmlStmt += "<div>";
        ...
        //	htmlStmt += '<input onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" class="text_input_area" type="text" maxlength="20">';
        htmlStmt += '<span class="pick_set" id="pick_set_' + (x + 1) + '_1">';
        for (let i = 0; i < tmpObj.options.length; i++) {
          htmlStmt +=
            '<span class="pick" id="pick_' +
            (x + 1) +
            "_1_" +
            (x + 1) +
            '" data-opttext="">' +
        ...
        // htmlStmt += '<span class="sta_txt_cont"></span>';
        htmlStmt += "</div>"; // - end fill_box
        htmlStmt += '<div class="icon_wrap" style="display: none;">';
        htmlStmt +=
          '<div class="tick" style="display: none;"><img src="../images/icons/check_btn.png"></div>';
        htmlStmt +=
          '<div class="cross" style="display: none;"><img src="../images/icons/cross_btn.png"></div>';
      ...
      if (aObj.image != "") {
        if (aObj.imageposition == "back") {
          htmlStmt +=
            '<div class="img_holder d-flex justify-content-center align-items-center">';
          htmlStmt += '<div class="img_space "><img src="' + aObj.image + '">';
