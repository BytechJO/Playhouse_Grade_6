...
var fillin_data = {
  ...
  subTitleTextRight:
    "Look at each picture and write a sentence about it in the present perfect continuous tense.",
  subTitleIcons: [],
  ...
  questions: [
    {
      ...
      answer: [
        "the children have been discovering many new things in the forest",
      ],
    ...
    },
    {
      ...
      answer: [
        "the family has been trekking through the mountains for one week",
      ],
      strictcase: "no", // yes (or) no
      type: "text", // text (or) number
    },
