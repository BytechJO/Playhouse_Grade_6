function buildFillInBody(aObj) {
  ...
  if (typeof aObj != undefined && aObj != null) {
    ...
    htmlStmt += "</div>";
    htmlStmt += "</div>";
    if (aObj.eaxampple != undefined && aObj.eaxampple != "") {
      htmlStmt += '<div class="example_text">';
      htmlStmt += aObj.eaxampple;
      htmlStmt += "</div>";
    }
    // ===================================================================== all_cont =====================
    ...
    for (x = 0; x < numOfRows; x++) {
      ...
      for (y = 0; y < numInRowArray[x].length; y++) {
        ...
        if (array_images != undefined && array_images != "") {
          htmlStmt +=
            '<div class="q_array_images d-flex flex-wrap ' +
          ...
          for (let x = 0; x < array_images.length; x++) {
            htmlStmt +=
              ...
              aObj.questions[currentQue - 1].array_images_audio[x] +
              '">';
