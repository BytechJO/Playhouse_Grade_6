function buildMcqBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		for(x= 0;x<numberofCols;x++){	
			...
			for(y= 0;y<numOfQinCol;y++){
				...
				if(typeof tpOb != undefined && tpOb != null ){
					htmlStmt += '<div class="que d-flex flex-wrap background_audio" id="que_'+currQueNum+'" data-qno="'+currQueNum+'">';
					...
					// htmlStmt += '</div>'; // - /q_part
					htmlStmt += '<div class="d-flex flex-column picks_grp">';
					...
					if(aObj.images){
					htmlStmt += '<div class="q_img"><img src="'+aObj.images[y]+'" class="q-img-'+y+'"></div>';
					}
		...
		// htmlStmt += '<img src="../images/pages/page-img/img-clock.png"/>';
		// htmlStmt += '</div>';
