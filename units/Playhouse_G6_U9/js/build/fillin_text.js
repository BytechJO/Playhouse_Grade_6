	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		if(aObj.image != 'no' && aObj.image != ""){
			if(aObj.imageposition == 'front'){
				htmlStmt += '<div class="img_space"><img src="'+aObj.image+'"></div>';
			}
		}
		htmlStmt += '<div class="group_elm">';
		
			if(aObj.images){
				htmlStmt += '<div class="images_container">';
				for(let y=0; y<aObj.images.length; y++){
					htmlStmt += '<img src="'+aObj.images[y]+'" class="img-'+y+' pulse">';
				}
				htmlStmt += '</div>';
			}
		...
		if(aObj.image != 'no' && aObj.image != ""){
			if(aObj.imageposition == 'back'){
				htmlStmt += '<div class="img_space"><img src="'+aObj.image+'" class="pulse"></div>';
			}
		}
