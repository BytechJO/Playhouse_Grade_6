...
var fillin_data = {
  ...
  subTitleTextRight:
    "Read each sentence. Write '<span class='red_text'>S</span>' if the sentence is simple future and write '<span class='red_text'>P</span>' if the sentence is future perfect.",
  subTitleIcons: [],
