function buildMcqBody(aObj) {
  ...
  if (typeof aObj != undefined && aObj != null) {
    ...
    htmlStmt += '<div class="static_question_number">2</div>';

    htmlStmt +=
      '<div class="static_question_text">' +
      "Why did Nancy start a friendship with Michele?" +
      "</div>";
    ...
    htmlStmt += '<div class="static_question_number">3</div>';

    htmlStmt +=
      '<div class="static_question_text">' +
      "Why did Nancy and Michele stop writing letters?" +
      "</div>";
    ...
    htmlStmt +=
      '<div class="static_question_text">' +
      "What did Nancy’s husband buy for her as a birthday present?" +
      "</div>";
