    ...
    for (var slideIndex = 0; slideIndex < aObj.slides.length; slideIndex++) {
      ...
      if (slide.layout == "text_on_image") {
        if (slide.wordsBackground != undefined) {
          slideHtml +=
            "<div class='d-flex read_grammer' style='text-align: center;'>";
          ...
          for (var wordsIndex = 0; wordsIndex < allWords.length; wordsIndex++) {
            slideHtml +=
              "<div class='snap_card audioIcon mx-0 mx-md-auto audioTile audioIcon' data-slideNum='" +
              Number(slideIndex + 1) +
              "' data-audio='" +
        ...
        for (
          ...
          slideHtml +=
            "<div class='image_audio' style='top:" +
            conv.imgPos["top"] +
            " ; left:" +
            conv.imgPos["left"] +
            " ;'>";
          slideHtml +=
            "<div class='snap_card audioIcon mx-0 mx-md-auto' data-slideNum='" +
            Number(slideIndex + 1) +
            "' data-audio='" +
            conv.audio +
            "'data-onaudioplay=''>";
        ...
        slideHtml +=
          "<div class='d-flex justify-content-center align-items-center grid_columns_container " +
        ...
        slideHtml +=
          ...
          slide.rule_toggle_btn +
          "</div>";
        slideHtml +=
          "<div class='gram_btn Example pulse example_toggle_btn'>" +
          slide.example_toggle_btn +
          "</div>";
        slideHtml += "</div>";
        slideHtml +=
          "<img src='" + slide.welcomeImage + "' class='welcomeImage'/>";
        // == border divs ================
        ...
        if (ImagePos != undefined) {
          for (var snapIndex = 0; snapIndex < ImagePos.length; snapIndex++) {
            ...
            for (
              var imgIndex = 0;
              imgIndex < ImagePos[snapIndex].colData.length;
              imgIndex++
            ) {
              slideHtml +=
                "<div class='col-12 col-md-" +
                ImagePos[snapIndex].colWidth[imgIndex] +
                " col_card'>";
              slideHtml +=
                "<div class='snap_card mx-0 mx-md-auto audioIcon' data-slideNum='" +
                Number(slideIndex + 1) +
                "' data-audio='" +
                audioArry[curIndex] +
                "'data-onaudioplay=''>";
        ...
        if (examplesTextPos != undefined) {
          ...
          for (
            var snapIndex = 0;
            snapIndex < examplesTextPos.length;
            snapIndex++
          ) {
            slideHtml +=
              "<div class='snap_group_" +
            ...
            for (
              var imgIndex = 0;
              imgIndex < examplesTextPos[snapIndex].colData.length;
              imgIndex++
            ) {
              slideHtml +=
                "<div class='col-12 col-md-" +
                examplesTextPos[snapIndex].colWidth[imgIndex] +
                " col_card'>";
              slideHtml +=
                "<div class='snap_card mx-0 mx-md-auto audioIcon' data-slideNum='" +
                Number(slideIndex + 1) +
        ...
        if (slide.mainImage != undefined && slide.mainImage != "") {
          slideHtml +=
            "<img src='" + slide.mainImage + "' style='width: 100%;'/>";
        }
        if (slide.middleImage != undefined && slide.middleImage != "") {
          slideHtml +=
            "<img src='" + slide.middleImage + "' class='middle_image' />";
        }
        slideHtml +=
          "<div class='snap_group_all cont_group' style='" +
          slide.group_styles +
          "'>";
        if (slide.topText) {
          ...
          for (var snapIndex = 0; snapIndex < ImagePos.length; snapIndex++) {
            ...
            for (
              ...
              slideHtml +=
                ...
                " grid_col'>";
              slideHtml +=
                "<div class='snap_card audioIcon' data-slideNum='" +
                Number(slideIndex + 1) +
                "' data-audio='" +
                audioArry[curIndex] +
                "'data-onaudioplay=''>";
        ...
        if (bottomImagePos != undefined) {
          ...
          slideHtml +=
            "<img src='" + slide.bottomImage + "' class='back_bottom_image' />";
          // bottomImage
          // bottomAudio
          // bottomWord
          // bottomImagePlacePos
          for (
            var snapIndex = 0;
            snapIndex < bottomImagePos.length;
            snapIndex++
          ) {
            slideHtml +=
              "<div class='snap_group_" + Number(snapIndex + 1) + " row mx-0'>";
            for (
              var imgIndex = 0;
              imgIndex < bottomImagePos[snapIndex].colData.length;
              imgIndex++
            ) {
              slideHtml +=
                "<div class='col-12 col-md-" +
                bottomImagePos[snapIndex].colWidth[imgIndex] +
                "'>";
              slideHtml +=
                "<div class='snap_card audioIcon' data-slideNum='" +
                Number(slideIndex + 1) +
                "' data-audio='" +
                bottomAudioArry[curIndex] +
                "'data-onaudioplay=''>";
        ...
        slideHtml +=
          "<div class='snap_card audioTile audioIcon' data-slideNum='" +
          Number(slideIndex + 1) +
          "' data-audio='" +
          slide.mainTextAudio +
          "'data-onaudioplay=''>";
        ...
        for (var box = 0; box < slide.imagePlacePos.length; box++) {
          ...
          if (slide.boxTitle[box] != undefined) {
            slideHtml +=
              "<div class='snap_card audioTile audioIcon box_title' data-slideNum='" +
              Number(slideIndex + 1) +
              "' data-audio='" +
          ...
          groupClass =
            slide.word[box][curIndex].charAt(0) == "."
          ...
          if (ImagePos != undefined) {
            for (var snapIndex = 0; snapIndex < ImagePos.length; snapIndex++) {
              slideHtml +=
                "<div class='snap_group_" + Number(snapIndex + 1) + " row'>";
              for (
                var imgIndex = 0;
                imgIndex < ImagePos[snapIndex].colData.length;
                imgIndex++
        ...
        slideHtml += "<div class='image_with_text'>";
        slideHtml +=
          "<img src='" + slide.secondImage + "' class='image_floating_right'/>";
        slideHtml += "<div class='main_image'>";
        slideHtml +=
          "<img src='" + slide.mainImage + "' class='main_image_background'/>";
        slideHtml += "</div>";
        slideHtml +=
          "<div class='snap_card audioTile audioIcon title_text' data-slideNum='" +
          Number(slideIndex + 1) +
          "' data-audio='" +
          slide.titleAudio +
          "'data-onaudioplay=''>";
        ...
        for (
          ...
          slideHtml +=
            ...
            " ;'>";
          slideHtml +=
            "<div class='snap_card mx-0 mx-md-auto audioTile audioIcon' data-slideNum='" +
            Number(slideIndex + 1) +
            "' data-audio='" +
            conv.audio +
            "'data-onaudioplay=''>";
        ...
        slideHtml +=
          "<div class='image_with_text " + slide.parent_class_name + "'>";
        ...
        if (slide.titleText != undefined && slide.titleText != "") {
          ...
          slideHtml +=
            "<div class='snap_card audioIcon title_text' data-slideNum='" +
            Number(slideIndex + 1) +
            "' data-audio='" +
            slide.titleAudio +
            "'data-onaudioplay=''>";
          ...
          slideHtml +=
            "<div class='snap_card audioIcon title_image' data-slideNum='" +
            Number(slideIndex + 1) +
            "' data-audio='" +
            slide.titleAudio +
            "'data-onaudioplay=''>";
        ...
        for (var boxnum = 0; boxnum < slide.boxes.length; boxnum++) {
          ...
          slideHtml +=
            '<img src="' + slide.boxes[boxnum].image + '" alt="Front Image">';
          slideHtml += "</div>";

          slideHtml += '<div class="back">';
          slideHtml +=
            '<img src="' + slide.boxes[boxnum].image + '" alt="Back Image">';
        ...
        slideHtml += "</div>";
      } else if (slide.layout == "past_participle_card") {
        slideHtml +=
          "<div class='past_participle_layout " +
          (slide.parent_class_name || "") +
          "'>";
        ...
        slideHtml += "<div class='pp_paper'>";

        // ========================================
        // DECORATION
        // ========================================

        slideHtml += "<div class='pp_tape pp_tape_left'></div>";
        slideHtml += "<div class='pp_tape pp_tape_right'></div>";

        slideHtml += "<div class='pp_notebook_holes'>";
        ...
        slideHtml +=
          "<div class='snap_card audioIcon pp_title_audio' " +
          "data-slideNum='" +
          Number(slideIndex + 1) +
          "' " +
          "data-audio='" +
        ...
        slideHtml += "<div class='pp_title'>" + slide.title + "</div>";
        ...
        slideHtml +=
          "<div class='snap_card audioIcon pp_description_audio' " +
          "data-slideNum='" +
          Number(slideIndex + 1) +
          "' " +
          "data-audio='" +
        ...
        slideHtml +=
          "<div class='pp_description'>" + slide.description + "</div>";
        ...
        slideHtml += "<div class='pp_tables'>";

        // =====================================================
        // REGULAR VERBS
        // =====================================================

        slideHtml += "<div class='pp_table_box'>";

        slideHtml +=
          "<div class='pp_table_title'>" + slide.regularTitle + "</div>";

        slideHtml += "<div class='pp_table'>";

        // TABLE HEAD

        slideHtml += "<div class='pp_table_row pp_table_head'>";

        slideHtml += "<div>Past</div>";

        slideHtml += "<div>Past Participle</div>";

        slideHtml += "</div>";

        // TABLE DATA

        for (var r = 0; r < slide.regularVerbs.length; r++) {
          slideHtml += "<div class='pp_table_row'>";

          slideHtml +=
            "<div class='pp_past'>" + slide.regularVerbs[r].past + "</div>";

          slideHtml +=
            "<div class='pp_participle'>" +
            slide.regularVerbs[r].participle +
            "</div>";
        ...
        slideHtml +=
          "<div class='pp_table_title'>" + slide.irregularTitle + "</div>";
        ...
        for (var ir = 0; ir < slide.irregularVerbs.length; ir++) {
          slideHtml += "<div class='pp_table_row'>";

          slideHtml +=
            "<div class='pp_past'>" + slide.irregularVerbs[ir].past + "</div>";

          slideHtml +=
            "<div class='pp_participle'>" +
            slide.irregularVerbs[ir].participle +
            "</div>";
        ...
        // end layout
        slideHtml += "</div>";
      } else if (slide.layout == "pen_friend_writing") {
        slideHtml +=
          "<div class='pen_friend_reading " +
          (slide.parent_class_name || "") +
          "'>";
        ...
        slideHtml += "<div class='pen_intro_box'>";

        slideHtml += "<div class='pen_intro_text'>";
        slideHtml += slide.introText;
        slideHtml += "</div>";

        if (slide.introImage != undefined && slide.introImage != "") {
          slideHtml +=
            "<div class='pen_intro_image'>" +
            "<img src='" +
            slide.introImage +
            "'>" +
            "</div>";
        ...
        slideHtml += "<div class='pen_steps'>";

        slideHtml +=
          "<div class='pen_steps_title'>" + slide.stepsTitle + "</div>";

        slideHtml += "<ul>";

        for (var step = 0; step < slide.steps.length; step++) {
          slideHtml += "<li>" + slide.steps[step] + "</li>";
        }
        ...
        slideHtml +=
          "<div class='pen_example_title'>" + slide.exampleTitle + "</div>";

        // =====================================================
        // LETTER
        // =====================================================

        slideHtml += "<div class='pen_letter_box'>";

        if (slide.letterImage != undefined && slide.letterImage != "") {
          slideHtml +=
            "<div class='pen_letter_image'>" +
            "<img src='" +
            slide.letterImage +
            "'>" +
            "</div>";
        ...
        slideHtml +=
          "<div class='pen_letter_text'>" + slide.letterText + "</div>";
