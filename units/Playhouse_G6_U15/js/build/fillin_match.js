/*$(function () {
    ...
    function buildFillInBody(aObj) {
        ...
        // ===================================================================== all_cont =====================
                ...
                htmlStmt += '<div class="all_cont justify-content-center ht_100 align-items-center d-flex">';

                for (x = 0; x < numOfRows; x++) {
                    htmlStmt += '<div class="questions-container">';
                    for (y = 0; y < numInRowArray[x].length; y++) {
                        var tmpObj = ((aObj.questions)[currentQue - 1])
                        htmlStmt += '<div class="p-0" style="height: 80px">'; // put hight in css or data 
                        ...
                        htmlStmt += '<div class="txtBox mx-2" data-type="text">';
                            ...
                            htmlStmt += '<div class="audioIcon off d-flex contant " data-audio="' + tmpObj.textback_audio + '">';
                                htmlStmt += '<span>' + ((aObj.questions)[currentQue - 1]).textback + '</span>'
                            htmlStmt += '</div>';
                        htmlStmt += '</div>';
                        htmlStmt += '<div class="r-choice">'
                            htmlStmt += '<div class="audioIcon off contant " data-audio="' + tmpObj.textend_audio + '">';
