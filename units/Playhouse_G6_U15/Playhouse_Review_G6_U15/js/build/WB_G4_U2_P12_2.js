...
htmlStmt += '<div class="puzzle_clues_right">';
...
if (
  cluesObj.down != undefined &&
  cluesObj.down.length > 0
) {
...
if (
  cluesObj.across != undefined &&
  cluesObj.across.length > 0
) {
