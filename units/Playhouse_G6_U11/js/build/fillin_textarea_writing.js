function buildFillInBody(aObj) {
    ...
    if (typeof aObj != undefined && aObj != null) {
        ...
        // OPTIONAL TEXT
        // =========================================================
        if (aObj.text && aObj.text.length > 0) {
        ...
        // NOTEBOOK
        // =========================================================
        htmlStmt += '<div class="area">';

        htmlStmt +=
            '<img src="../images/pages/activities/Asset 5.png" class="background_img">';

        htmlStmt += '<div class="textarea-container">';

        htmlStmt +=
            '<textarea class="paper-textarea text1" maxlength="400"></textarea>';

        htmlStmt +=
            '<textarea class="paper-textarea text2" maxlength="400"></textarea>';
