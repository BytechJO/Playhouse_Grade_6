var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/p96/UNIT_11_Making_the_Right_Choices.mp3",
       "title":{
           "text": "Making the Right Choices",
    ...
    "footer": {
        ...
        "bgcolor": "linear-gradient(0deg, #00b7ce 0%, rgba(255,255,255,0) 100%)",       
        "buttons"    : [],
        "filetoload" : [],
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G6_U11/views/fillin_text_in_sentences_4.html'
        },
        "booksbutton" : { 
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G6_WB/views/free_fillin_on_image.html'
            },
            "studentbook": {
