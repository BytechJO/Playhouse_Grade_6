var snapshot_data = {
  snapshot: [
    {
      audio: [
        "../audios/p96/pizza.mp3",
        "../audios/p96/dough.mp3",
        "../audios/p96/sauce.mp3",
        "../audios/p96/sprinkle.mp3",
        "../audios/p96/cheese.mp3",
        "../audios/p96/add.mp3",
        "../audios/p96/pepperoni.mp3",
        "../audios/p96/slice.mp3",
      ],
      image: [
...
var Popups_data = {
  slides: [
    {
      ...
      listen: {
        ...
        titleIcons: [""],
        titlesAudio: [
          "../audios/p96/Pg4_1.2_Adult_Lady.mp3",
          "../audios/p96/Pg4_1.3_Adult Lady.mp3",
          "../audios/p96/Pg4_1.4_Adult Lady.mp3",
        ],
        image: [
        ...
        words: [
          "<span class='number_bold'>1</span> stretch/stretching",
          "<span class='number_bold'>2</span> sweat/sweating",
          "<span class='number_bold'>3</span> jog/jogging",
          "<span class='number_bold'>4</span> get in shape/get fit",
          "<span class='number_bold'>5</span> sit-ups",
          "<span class='number_bold'>6</span> push-ups",
          "<span class='number_bold'>7</span> work out/working out",
          "<span class='number_bold'>8</span> cool down",
          "<span class='number_bold'>9</span> warm up/warming up",
          "<span class='number_bold'>10</span> balanced diet",
          "<span class='number_bold'>11</span> healthy meal",
          "<span class='number_bold'>12</span> exercise/exercising",
        ],
        audio: [
          "../audios/p96/1_stretch_stretching.mp3",
          "../audios/p96/2_sweat_sweating.mp3",
          "../audios/p96/3_jog_jogging.mp3",
          "../audios/p96/4_get_in_shape_get_fit.mp3",
          "../audios/p96/5_sit_ups.mp3",
          "../audios/p96/6_push_ups.mp3",
          "../audios/p96/7_work_out_working_out.mp3",
          "../audios/p96/8_cool_down.mp3",
          "../audios/p96/9_warm_up_warming_up.mp3",
          "../audios/p96/10_balanced_diet.mp3",
          "../audios/p96/11_healthy_meal.mp3",
          "../audios/p96/12_exercise_exercising.mp3",
        ],
      },
      listen2: {
        ...
        audio: [
          "../audios/p96/Pg5_2.2_Adult Lady.mp3",
          "../audios/p96/Pg5_2.3_Adult Lady.mp3",
        ],
      },
      listen3: {
        // "leftImage": "../images/pages/snapshots/page-2/popup-2-left-img.png",
        ...
        titleIcons: [""],
        titleTextRight:
          "<span class='blue_text'>What’s your favourite kind of exercise? Do you get regular exercise? Do you eat foods that are good for you?</span>",
  ...
  postions: [
    "left:30.80%; top:10.41%;",
    "left:38.91%; top:6.70%;",
    "left:46.09%; top:23.56%;",
    "left:60.95%; top:30.21%;",
    "left:27.05%; top:39.32%;",
    "left:39.79%; top:42.19%;",
    "left:53%; top:42.82%;",
    "left:32.62%; top:65.36%;",
    "left:43.71%; top:64.58%;",
    "left:23.23%; top:88.46%;",
    "left:37.07%; top:87.72%;",
    "left:52.93%; top:90.59%;",
  ],
  imagesAudio: [
    "../audios/p96/1_stretch_stretching.mp3",
    "../audios/p96/2_sweat_sweating.mp3",
