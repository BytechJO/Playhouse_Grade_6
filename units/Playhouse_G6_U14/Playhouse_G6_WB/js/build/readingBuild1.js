function buildReadingHTML(aObj) {
  ...
  // =========================================================
  // CHECK IF WE HAVE 2 GRID COLUMNS
  // =========================================================

  var isTwoGridColumns =
    aObj.slides.length === 2 &&
    aObj.slides[0].layout === "grid_columns" &&
    aObj.slides[1].layout === "grid_columns";

  slideHtml +=
    "<div class='all_cont d-flex justify-content-center align-items-center " +
    (isTwoGridColumns ? "two_grid_columns_page" : "") +
    "'>";
    ...
    for (var slideIndex = 0; slideIndex < aObj.slides.length; slideIndex++) {
      ...
      if (slide.layout == "grid_columns") {
        ...
        if (slide.grid_main_title != undefined && slide.grid_main_title != "") {
          ...
          slideHtml += "<div>" + slide.grid_main_title_text + "</div>";
