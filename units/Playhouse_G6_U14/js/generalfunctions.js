        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "reportedtickunderline":
              if (
                typeof reported_tick_underline_data !== "undefined" &&
                reported_tick_underline_data != null
              ) {
                buildReportedTickUnderlineBody(reported_tick_underline_data);
              }
