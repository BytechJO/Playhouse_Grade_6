function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		// ===========================================================
		htmlStmt += '<div class="screen_elements h-100 w-100 d-flex flex-wrap">';

		htmlStmt += '<div class="group_elm ">';
			
		
		htmlStmt += '<div class="group_elements d-flex flex-column justify-content-center align-items-center">';
		htmlStmt += '<div class="audioIcon off d-flex contant" data-audio="">' ;
		htmlStmt += '<img class="que_image" src="' + aObj.image + '">';
		htmlStmt += '</div>';
		...
		// 	htmlStmt += '<img class="img" src="'+aObj.image+'"/>';
