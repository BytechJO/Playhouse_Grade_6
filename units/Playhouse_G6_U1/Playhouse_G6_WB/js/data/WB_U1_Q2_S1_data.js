...
var fillin_data = {
    ...
    "questions": [{
        ...
        {
            "textfront": "No, we won’t go on air until 10:30.</br>But you can hear the breaking news now.",
            "textback": "Tour Guide: ",
            "audio": "../audios/p5/under.mp3",
            "audioenable": "default", // correct (or) default
            "image": "no",
        ...
        {
            "textfront": "Can we hear the breaking news and then seemore things in the studio, Mrs. Nelson?I always wanted to see a reporter’s teleprompterand a camera operator’s equipment.",
            "textback": "Student: ",
            "audio": "../audios/p5/under.mp3",
        ...
        {
            "textfront": "Yes, we will see the broadcast in a few minutes. But remember that they’re doing the news live, so we’ll need to be quiet and careful.",
            "textback": "Teacher: ",
            "audio": "../audios/p5/under.mp3",
            "audioenable": "no", // correct (or) default
            "image": "no",
        ...
        {
            "textfront": "This is great! I’ve always wondered how TV shows were done. Now we get to see it! Is the one who is speaking into the microphone the reporter?",
            "textback": "Student: ",
            "audio": "../audios/p5/under.mp3",
