function buildFillInBody(aObj) {
  ...
  if (aObj != undefined && aObj != null) {
    ...
    htmlStmt += '<div class="group_elm d-flex flex-wrap flex-column">';
    for (x = 0; x < numOfQuestions; x++) {
      ...
      var str =tmpObj.textfront;
      
      console.log(tmpObj.text,"tmpObj.text");
      // var count = (str.match(/[_]/g) || []).length;                
      var qStr = str.replace(/\[_]/g, '<div> <input class="text_input_area" type="text" maxlength="' + tmpObj.maxlength + '" data-type="' + tmpObj.type + '"> </div>');
      ...
      htmlStmt += '<div class="audioIcon off d-flex contant " data-audio="' + ((aObj.questions)).audio + '">';
        htmlStmt += qStr;
      htmlStmt +='</div>'
  ...
  htmlStmt += '<img src="../images/pages/activities/WB_U1_Q33.jpg"/>';
htmlStmt += '</div>';
