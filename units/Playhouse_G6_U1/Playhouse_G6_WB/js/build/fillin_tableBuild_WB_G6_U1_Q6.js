    ...
    function buildFillInBody(aObj) {
        ...
        htmlStmt += '</div>';
            ...
            if (layOut == 3) {
                ...
                // htmlStmt += '</div>';
                for (x = 0; x < numOfRows; x++) {
                    htmlStmt += '<div class="d-flex flex-column table">';
                    for (y = 0; y < numInRowArray[x].length; y++) {
                        

                        htmlStmt += '<div class="p-0 q_Box d-flex">';
                            htmlStmt += '<div class="img-container">'
                                htmlStmt += '<img src='+((aObj.questions)[currentQue - 1]).image+'>';
                            htmlStmt += '</div>'                            
                        htmlStmt += '<div class="que que_' + currentQue + 'w-75 h-100 d-flex align-items-center" data-qno="' + (currentQue) + '">';
    
                        // htmlStmt += '<div class="image_wrap"><img src="'+((aObj.questions)[currentQue-1]).image+'"></div>';
                        htmlStmt += '<div class="txt_wrap d-flex">';
                        ...
                        htmlStmt += '<div class="d-flex textEnd justify-content-end">'+((aObj.questions)[currentQue - 1]).textend+'</div>';
