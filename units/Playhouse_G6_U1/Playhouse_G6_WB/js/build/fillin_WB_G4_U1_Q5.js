function buildFillInBody(aObj) {
  ...
  if (aObj != undefined && aObj != null) {
    ...
    for (x = 0; x < numOfQuestions; x++) {
      ...
      // htmlStmt += '<div class="d-flex align-items-center">';
      //   htmlStmt += '<div class="audioIcon off d-flex contant min_w_fit_contant" data-audio="' + aObj.questions[x].audio + '">';
      //       htmlStmt += tmpObj.textbackkk;
      //   htmlStmt += '</div>'
        
        htmlStmt += '<div class="audioIcon off d-flex contant " data-audio="' + aObj.questions[x].audio + '">';
          htmlStmt += tmpObj.textbackkk;
        htmlStmt += '</div>';  
  ...
  htmlStmt += '<img src="../images/pages/activities/WB_U1_Q55.jpg"/>';
  htmlStmt += '</div>';
