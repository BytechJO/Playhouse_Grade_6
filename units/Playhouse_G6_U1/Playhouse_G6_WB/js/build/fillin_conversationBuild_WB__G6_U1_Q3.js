function buildFillInBody(aObj) {
  ...
  if (aObj != undefined && aObj != null) {
    ...
    htmlStmt +=
      '<div class="group_elm d-flex flex-wrap justify-content-center flex-column">';
    for (x = 0; x < numOfQuestions; x++) {
      ...
      htmlStmt += '<div class="align-items-center">';
      htmlStmt +=
        '<div class="audioIcon off  min_w_fit_contant" data-audio="' +
        tmpObj.audio +
        '">';
