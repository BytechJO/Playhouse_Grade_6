function buildFillInBody(aObj) {
  ...
  if (aObj != undefined && aObj != null) {
    ...
    htmlStmt += '<div class="all_sentences">';
    for (x = 0; x < aObj.sentences.length; x++) {
      htmlStmt += '<div class="audioIcon off  min_w_fit_contant" data-audio="' + aObj.sentences_audio[x] + '">';
            htmlStmt += aObj.sentences[x];
        htmlStmt += '</div>'
    }
    htmlStmt += '</div>';
    ...
    for (x = 0; x < numOfQuestions; x++) {
      ...
      htmlStmt += '<div class="fillin_gr d-flex align-items-center w-100" style="line-height:30px">';
      htmlStmt += '<div class="q_space w-100">';
      
      htmlStmt += '<div class="align-items-center d-flex">';
        // htmlStmt += '<div class="audioIcon off  min_w_fit_contant" data-audio="' + tmpObj.audio+ '">';
        //     htmlStmt += tmpObj.textbackkk;
        // htmlStmt += '</div>'

        htmlStmt += '<span class="ques_num">' + (x + 1) + '</span>';
  ...
  htmlStmt += '<img src="../images/pages/activities/WB_U1_Q4.jpg"/>';
  htmlStmt += '</div>';
