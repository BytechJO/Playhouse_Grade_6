    ...
    function buildFillInBody(aObj) {
        ...
        if (aObj != undefined && aObj != null) {
            ...
            if (layOut == 3) {
                ...
                // htmlStmt += '</div>';
                for (x = 0; x < numOfRows; x++) {
                    htmlStmt += '<div class=" w-85 h-100">';
                    for (y = 0; y < numInRowArray[x].length; y++) {
                        

                        htmlStmt += '<div class="p-0" style="height: 60px">'; // put hight in css or data 
                        ...
                        htmlStmt += '<div class="txtBox mx-2" data-type="text">';
                            ...
                            htmlStmt += '</div>';
                        htmlStmt += '</div>';
                        htmlStmt += '<div class="audioIcon off contant " style="width:50%" data-audio="../audios/under.mp3">';                         
