  ...
  if (typeof aObj !== undefined && aObj.slides.length != 0 && aObj != null) {
    for (var slideIndex = 0; slideIndex < aObj.slides.length; slideIndex++) {
      ...
      if (slide.layout == "text_on_image") {
        ...
        slideHtml += "</div>";
      } else if (slide.layout == "wish_boxes") {
        slideHtml +=
          "<div class='wish_boxes_activity " + slide.parent_class_name + "'>";

        // =========================================
        // BOXES
        // =========================================
        slideHtml += "<div class='wish_boxes_grid'>";

        for (var wishIndex = 0; wishIndex < slide.wishes.length; wishIndex++) {
          var wish = slide.wishes[wishIndex];

          slideHtml +=
            "<div class='wish_box wish_box_" + (wishIndex + 1) + "'>";

          // TITLE + INPUT
          slideHtml += "<div class='wish_title_row'>";

          slideHtml += "<span class='wish_title'>" + wish.title + "</span>";

          slideHtml +=
            "<input " +
            "type='text' " +
            "class='wish_title_input' " +
            "placeholder='" +
            (wish.inputPlaceholder || "") +
            "'>";
          ...
          // LABEL
          slideHtml +=
            "<div class='wish_reason_label'>" + wish.textareaLabel + "</div>";

          // TEXTAREA
          slideHtml += "<textarea class='wish_reason_textarea'></textarea>";
        ...
        // IMAGE
        // =========================================
        if (slide.bottomImage != undefined && slide.bottomImage != "") {
          slideHtml += "<div class='wish_bottom_image'>";

          slideHtml += "<img src='" + slide.bottomImage + "'>";
