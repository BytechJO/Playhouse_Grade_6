...
var fillin_data = {
  ...
  subTitleTextRight:
    "Read each sentence and match it to the correct <span class='red_text'>hope</span> or <span class='red_text'>wish</span>.",
  subTitleIcons: [],
  ...
  questions: [
    ...
    },
    {
      textfront: " ",
      textback:
        "&nbsp; 2 &nbsp; The park is so far. I have to ask my dad to drive me there.",
    ...
    },
    {
      ...
      textend:
        "<b>d.</b> &nbsp; I hope he remembers to sort them better next time.",
      textback_audio: "../audios/under.mp3",
      textend_audio: "../audios/under.mp3",
      audio: "",
      audioenable: "no", // correct (or) default
