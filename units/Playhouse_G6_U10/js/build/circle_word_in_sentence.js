function buildMcqBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		for(x= 0;x<numberofCols;x++){	
			htmlStmt += '<div class="question_group d-flex flex-column">';			
			for(y= 0;y<numOfQinCol;y++){
				...
				if(typeof tpOb != undefined && tpOb != null ){
					...
					htmlStmt += '<div class="'+className+' que_item" id="que_'+currQueNum+'" data-qno="'+currQueNum+'">';
					htmlStmt += '<div class="ques_line d-flex">';
					
						htmlStmt += '<div class="q_grp d-flex flex-wrap">';

						htmlStmt += '<div class="q_part d-flex flex-wrap align-items-baseline">';
					...
					htmlStmt += '<div class="text_container d-flex flex-column justify-content-center">';
						if(tpOb.textFront != undefined && tpOb.textFront != ""){
							htmlStmt += '<div class="audioIcon off contant not-disapled" data-audio="">';
								htmlStmt += '<div class="text">'+tpOb.textFront+'</div>';
							htmlStmt += '</div>';
						}
					...
					htmlStmt += '</div>'; 	
						if(tpOb.textEnd != undefined && tpOb.textEnd != ""){
							htmlStmt += '<div class="audioIcon off contant not-disapled" data-audio="">';
								htmlStmt += '<div class="text">'+tpOb.textEnd+'</div>';
							htmlStmt += '</div>';
						}
					htmlStmt += '</div>'; // - /q_part	
