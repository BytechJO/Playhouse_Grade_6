function buildMcqBody(aObj) {
  ...
  if (typeof aObj != undefined && aObj != null) {
    ...
    // htmlStmt += '</div>';
    // ======================================================
    // Extra Writing Question
    // ======================================================
    htmlStmt += '<div class="extra_question">';

    htmlStmt += '<div class="extra_question_text">';
    htmlStmt +=
      "How can Yoshi and Lilly get the students in sixth grade excited about recycling?";
    htmlStmt += "</div>";

    htmlStmt += '<textarea class="extra_answer" rows="3"></textarea>';
