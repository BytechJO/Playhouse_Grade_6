...
var fillin_data = {
  ...
  subTitleTextRight:
    "Read each sentence and categorise it. Write '<span class='red_text'>P</span>' for past, '<span class='red_text'>PR</span>' for present and '<span class='red_text'>F</span>' for future.",
  subTitleIcons: [],
