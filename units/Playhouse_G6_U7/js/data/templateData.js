var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/p60/UNIT_7___Adventures_in_Space.mp3",
       "title":{
           "text": "Adventures in Space",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G6_U7/views/fillin_text_in_sentences_2_2.html'
        },
        "booksbutton" : { 
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G6_WB/views/drag_drop_text.html'
            },
            "studentbook": {
