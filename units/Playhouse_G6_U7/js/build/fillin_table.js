function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
        ...
        // var numOfColumnss = numInRowArray.length;
    	var currentQue = 1;			
		...
		htmlStmt += '<div class="group_elm d-flex flex-wrap justify-content-center align-items-center mb-70">';
			...
			htmlStmt += '<div class="q_space w-100">';
				htmlStmt += '<div class="top_text">';
					htmlStmt += '<p>First, choose the person you would like to write about. You need to make sure there is plenty of information on this person.</p>';
					htmlStmt += '<p>Name of person:<input type="text" class="top_input"/></p>';
					htmlStmt += '<p>Next, do some research about the person’s life. List the main events of their life in order. Include dates whenever possible.</p>';
				htmlStmt += '</div>';
				...
				htmlStmt += '<table>';
					...
					// Loop of columns
					fieldIndex = 0;
					for(let col=0; col<numOfRow; col++){ //4
						htmlStmt += '<tr>';
				...
				htmlStmt += '</table>';
				htmlStmt += '<div class="top_text">';
					htmlStmt += '<p>Decide on your main focus for this person’s life. What were their main achievements? Include a few pictures or photos of the person to put in your biography.</p>';
				htmlStmt += '</div>';
			htmlStmt += '</div></div>';
		htmlStmt += '</div>';
