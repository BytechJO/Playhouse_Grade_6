function buildLineDrawBody(aObj) {
    ...
    if (aObj != undefined && aObj != null && aObj != {}) {
        ...
        htmlStmt += '<div class="drag_wrap d-flex align-items-center justify-content-center"> <div class="dragger">';
        ...
        if (dragsArr.length > 0) {
            for (var dg = 0; dg < dragsArr.length; dg++) {
                ...
                htmlStmt += '<div class="opt drag align-items-center d-flex" id="drag_' + (currentQue) + '_' + (dg + 1) + '">';
        ...
        if (dropsArr.length > 0) {
            for (var dp = 0; dp < dropsArr.length; dp++) {
                htmlStmt += '<div class="opt drop align-items-center d-flex" id="drop_' + (currentQue) + '_' + (dp + 1) + '">';
