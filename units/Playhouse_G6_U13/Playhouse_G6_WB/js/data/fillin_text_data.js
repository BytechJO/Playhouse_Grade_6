...
var fillin_data = {
  ...
  subTitleTextLeft:
    '<span class="blue_text">1</span> Solve it! Every other letter in the Word Power words has been left out. Fill in the missing letters, and then write the whole word in the blank.',
  subTitleTextRight: "",
  subTitleIcons: [],
  subTitleAudio:
    "../audios/P64/1_Solve_it!_Every_other_letter_in_the_Word_Power_words_has_been_left_out_Fill_in_the_missing.mp3",
