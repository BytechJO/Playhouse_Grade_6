function buildReadingHTML(aObj) {
    ...
    slideHtml +=
        '<i class="icon battery fa fa-battery-half"></i>';
    ...
    if (
        ...
        for (
            ...
            for (
                ...
                slideHtml +=
                    "<div class='slide-container slide-with-image'>";
    ...
    slideHtml +=
        '<div class="home_Btn" onclick="returnFirstSlide()"></div>';
