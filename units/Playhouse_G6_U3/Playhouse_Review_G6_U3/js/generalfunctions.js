        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "crosswordmystery":
              if (
                typeof crossword_mystery_data != undefined &&
                crossword_mystery_data != null
              ) {
                buildCrosswordMysteryBody(crossword_mystery_data);
              }

              break;
            case "actitout":
              if (
                typeof act_it_out_data != undefined &&
                act_it_out_data != null
              ) {
                buildActItOutBody(act_it_out_data);
              }
...
function doWindowResize() {
  ...
  if ($(".mask_parent").length > 0) {
    ...
    $(".rotator").css(
      "right",
      (Number(maskWidth.slice(0, -2)) - 15).toString() + "px",
    );
  }
}
function alignStage() {
