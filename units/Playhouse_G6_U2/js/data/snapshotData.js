...
var Popups_data = {
  slides: [
    {
      ...
      listen: {
        ...
        titleIcons: [""],
        titlesAudio: [
          "../audios/P12/Pg4_1.2_Adult_Lady.mp3",
          "../audios/P12/Pg4_1.3_Adult Lady.mp3",
          "../audios/P12/Pg4_1.4_Adult Lady.mp3",
        ],
        image: [
        ...
        words: [
          "<span class='number_bold'>1</span> producer",
          "<span class='number_bold'>2</span> screen",
          "<span class='number_bold'>3</span> script",
          "<span class='number_bold'>4</span> scene",
          "<span class='number_bold'>5</span> film (verb)",
          "<span class='number_bold'>6</span> director",
          "<span class='number_bold'>7</span> screenwriter",
          "<span class='number_bold'>8</span> horror film",
          "<span class='number_bold'>9</span> science fiction film",
          "<span class='number_bold'>10</span> action film",
          "<span class='number_bold'>11</span> documentary",
          "<span class='number_bold'>12</span> comedy film",
        ],
        audio: [
          "../audios/P12/1_producer.mp3",
          "../audios/P12/2_screen.mp3",
          "../audios/P12/3_script.mp3",
          "../audios/P12/4_scene.mp3",
          "../audios/P12/5_film_(verb).mp3",
          "../audios/P12/6_director.mp3",
          "../audios/P12/7_screenwriter.mp3",
          "../audios/P12/8_horror_film.mp3",
          "../audios/P12/9_science_fiction_film.mp3",
          "../audios/P12/10_action_film.mp3",
          "../audios/P12/11_documentary.mp3",
          "../audios/P12/12_comedy_film.mp3",
        ],
      },
      listen2: {
        ...
        audio: [
          "../audios/P12/Pg5_2.2_Adult Lady.mp3",
          "../audios/P12/Pg5_2.3_Adult Lady.mp3",
        ],
      },
      listen3: {
        // "leftImage": "../images/pages/snapshots/page-2/popup-2-left-img.png",
        ...
        titleIcons: [""],
        titleTextRight:
          "<span class='blue_text'>Have you ever taken a video of your family? How do you think films are made? Do you know anyone who has helped to make a film? </span>",
  ...
  postions: [
    "left: 21.98%; top: 27.34%;",
    "left: 33.45%; top: 8.62%;",
    "left: 46.12%; top: 14.79%;",
    "left: 48.78%; top: 25.25%;",
    "left: 34.75%; top: 36.67%;",
    "left: 41.26%; top: 36.67%;",
    "left: 56.0%; top: 27.85%;",
    "left: 35.75%; top: 49.69%;",
    "left: 42.26%; top: 49.69%;",
    "left: 47.32%; top: 49.69%;",
    "left: 56.76%; top: 49.69%;",
    "left: 72.53%; top: 49.69%;",
  ],
  popupDirections: [
    "bottom", //1
    "bottom", //2
