...
var reading_data = {
  ...
  subTitleIcons: [],
  subTitleAudio:
    "../audios/P13/1_Listen_and_read_Then_act_it_out_with_a_friend copy.mp3",
  slides: [
    {
      layout: "grid_columns",
      ...
      audio: [
        "../audios/P13/Pg6_2.1_Stella.mp3",
        "../audios/P13/dough.mp3",
        "../audios/P13/sauce.mp3",
        "../audios/P13/sprinkle.mp3",
        "../audios/P13/cheese.mp3",
        "../audios/P13/add.mp3",
        "../audios/P13/pepperoni.mp3",
        "../audios/P13/slice.mp3",
      ],
      word: [
      ...
      bottomWord: [
        ...
        "You’re so funny ... not!",
        "That’s a shame.",
        "(a description + not = I was just joking about what I said.)",
      ],
      bottomImagePlacePos: [
