function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		htmlStmt += '<div class="screen_elements h-100 w-100 d-flex flex-column">';
		// options
		...
		htmlStmt += '<div class="group_elm d-flex flex-column justify-content-center align-items-star mb-70">';
