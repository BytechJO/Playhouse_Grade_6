...
function writeHtml(activity, activity_html){
	...
	'<div class="act_head_group d-flex justify-content-center"> <div class="audioIcon off contant audioQuestionTitle" data-audio="' + activity.activityheading_audio + '"> <div class="activityHeading q_title">' + activity.activityheading + '</div> </div> </div>' +
