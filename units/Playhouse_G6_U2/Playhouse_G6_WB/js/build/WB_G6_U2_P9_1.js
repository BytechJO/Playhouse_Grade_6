    ...
    htmlStmt += '<div class="screen_elements d-flex flex-column">';
      ...
      // htmlStmt += '<div class="ques">';
        for (x = 0; x < numOfQuestions; x++) {
          ...
          var question = tmpObj.question;
          if(question !=""){
            htmlStmt += '<div class="audioIcon question txt-audioIcon off d-flex contant min_w_fit_contant" data-audio="' + tmpObj.audio + '">';
            htmlStmt += question;
            htmlStmt += '</div>';
          }
          ...
          htmlStmt += '<div class="q_space d-flex flex-wrap">';
            ...
            htmlStmt += '<div class="fillin_set justify-content-center d-flex flex-wrap">';
              htmlStmt += qStr;
