function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		htmlStmt += '<div class="screen_elements h-100 d-flex flex-column">';	
		// options
		...
		htmlStmt += '<div class="grou_elm d-flex flex-column w-100">';
	
			for(let y=0; y<aObj.numOfGroups; y++){
			
				htmlStmt += '<div class="group'+ Number(y+1) +'">';
				// htmlStmt += '<span class="title">'+aObj.titles[y]+'</span>';
				
				for (x = 0; x < numOfQuestions; x++) {
					var tmpObj = aObj.questions[x];
					if(tmpObj.groupNo == y+1){
						...
						var str = tmpObj.text;
						var qStr = '<div class="audioIcon txt-audioIcon background_audio off d-flex contant min_w_fit_contant" data-audio="' + tmpObj.textaudios[0] + '">' + '<img src="../images/icons/sound-wave.png" class="audio_icon">' + '</div>'
						...
						qStr = words.map((word, index) => {
							if (word !== '') {
							wordIndex++;
							return '<div class="audioIcon txt-audioIcon background_audio off d-flex contant min_w_fit_contant" data-audio="' + tmpObj.textaudios[wordIndex] + '">' + word + '</div>'
							}
						...
						htmlStmt += '<div class="q_space d-flex flex-column">';
							...
							htmlStmt += '<div class="audioIcon textEnd off d-flex contant" data-audio="">' ;
