        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "conversationunderline":
              if (
                typeof conversation_underline_data !== "undefined" &&
                conversation_underline_data != null
              ) {
                buildConversationUnderlineBody(conversation_underline_data);
              }
