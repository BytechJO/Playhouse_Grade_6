function initActivity(activity){
	...
	jQuery.each(activity.questions, function(key, question){
		...
		html += '<li><span class="question_text">'+question+'</span><span type="text" class="lineVal" value="" style="display: none;"/>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="getSelectedText(this)"><img src="../images/icons/new_pencil_underline.png" /></a><span type="text" class="circleVal" value="" style="display: none;"/></li>';
	});
	html += '</ul>';
	// html += '</div>';

	if(
		(typeof(activity.bottom_image)!='undefined') && (activity.bottom_image!='')) {
		html += '<div class="image_container"><img src="../images/pages/activities/'+activity.bottom_image+'" /></div>';
	}
