...
var fillin_data = {    
    ...
    "subTitleTextLeft"      : '<span class="blue_text">1</span> Answer it! Answer the questions about the conversation.',
    "subTitleTextRight"     : "",
    "subTitleIcons"         : [],
    ...
    "questions": [{
        ...
        },
        {
            ...
            "audioenable": "default", // correct (or) default
            "image": "",
            "answer": ["The director says yes to what Actor 1 asks because the director wants to talk to the producer for a minute"],
            "strictcase": "no", // yes (or) no
            "type": "text", // text (or) number
        },
        {
            "textfront": "How are action films and science fiction films different for the actors?",
            "audio": "../audios/under.mp3",
            "audioenable": "default", // correct (or) default
            "image": "",
            "answer": ["Action films and science fiction films are different for the actors because action films need many takes whereas science fiction films don't need as many"],
            "strictcase": "no", // yes (or) no
            "type": "text", // text (or) number
        },
    ]
