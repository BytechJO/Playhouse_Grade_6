...
function buildHtmlTitle(aObj) {
    if (typeof aObj != undefined && aObj != null) {
        if (typeof aObj.grade != undefined && aObj.grade != '' && typeof aObj.unit != undefined && aObj.unit != '') {
...
function buildHeader(aObj) {
    var homeVisible = (typeof (aObj.homebutton).visible != undefined && (aObj.homebutton).visible != null) ? (aObj.homebutton).visible : 'yes';
    var homeLink = ((_templatePath == '.') ? '../' : '') + '../../../' + (aObj.homebutton).link;
    var fStmt = '';
    if (typeof aObj != undefined && aObj != null) {
        ...
        if (typeof aObj.icon != undefined && aObj.icon != null) {
            fStmt += "<div class='unitIcon my-auto'>";
                ...
                //     fStmt += "<a href='" + _templatePath + aObj.grammer_link + "'><img src='" + _templatePath + aObj.grammer_icon + "' class='menu-content-item'></a>";
                //     fStmt += "<a href='" + _templatePath + aObj.vocabulary_link + "'><img src='" + _templatePath + aObj.vocabulary_icon + "' class='menu-content-item'></a>";
                //     fStmt += "<a href='" + _templatePath + aObj.poster_link + "'><img src='" + _templatePath + aObj.poster_icon + "' class='menu-content-item'></a>";
                // fStmt += "</div>";
            fStmt += "</div>";
        }
        fStmt += "</div>";
        ...
        fStmt += "<div class='col-1 col-xs-1 col-md-2 d-flex flex-wrap justify-content-between'>";
            ...
            fStmt += "<div class='d-flex flex-wrap justify-content-between' style='width: 100%;'>";
                ...
                fStmt += "<img src='" + _templatePath + _assetsPath + "home_btn.png' height='65px'>";
                fStmt += '</a>';
                fStmt += "</div>";
                if (isMobile())
                    fStmt += "<div class='full_screen hideInSmall my-auto' ><img src='" + _templatePath + _assetsPath + "fullscreen.png'></div>"
                else
                    fStmt += "<div class='full_screen my-auto'><img src='" + _templatePath + _assetsPath + "fullscreen.png'></div>"
            fStmt += "</div>";
...
function buildFooter(aObj) {
    ...
    if (typeof aObj.buttons != undefined && aObj.buttons != null && typeof aObj.filetoload != undefined && aObj.filetoload != null) {
        ...
        fStmt += "<div class='d-flex col-2 col-xs-2 col-md-2 flex-wrap justify-content-end'>";
            ...
            fStmt += "<img class='pt-1' src='" + _templatePath + _assetsPath + "rev.png'>";
            fStmt += '</a>';
            fStmt += "</div>";
        fStmt += "</div>";
        fStmt += "</div></div>";
...
function buildSubFooter(aObj, aVal) {
    ...
    if (thisisActivity && (thisFolder == 'views')) {
        if (typeof aObj != undefined && aObj != null) {
            ...
            // }
            // fStmt_ctrls = ''
            fStmt += '<div class="col-12 p-0 d-flex justify-content-end align-self-end">';
            ...
            for (var ff = 0; ff < (aObj.functionbuttons).length; ff++) {
                ...
                fStmt += '<img src="' + _templatePath + _assetsPath + ((tsubBtn == 'check') ? 'click' : tsubBtn) + '_btn.png"/>';
                fStmt += '</div>';
            }
            fStmt += '</div></div>';
            fStmt += '</div>';
