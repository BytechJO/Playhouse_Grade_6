        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "findfix":
              if (typeof find_fix_data != undefined && find_fix_data != null) {
                buildFindFixBody(find_fix_data);
              }

              break;
            case "blogwriting":
              if (
                typeof blog_writing_data != undefined &&
                blog_writing_data != null
              ) {
                buildBlogWritingBody(blog_writing_data);
              }
