  ...
  slides: [
    {
      ...
      array_text: [
        "<div class='reading_slide_with_img'>" +
          ...
          "enjoy your holiday.<br> Yesterday, my father told me that our flight will leave at 6:00pm. He said that if we want to " +
          "have a smooth check-in,then we should be there at least two hours before our flight leaves. That was a good idea. Our check-in was so easy." +
          "</div>" +
          "<div class='reading_side_img'>" +
          "<img src='../images/pages/activities/7.png'>" +
          "</div>" +
          "</div>",

        "<div class='reading_slide_with_img'>" +
          "<div class='reading_text'>" +
          " This year we are travelling with my little brother, Dean. He is only eight months old. My mum says that travelling with a baby isn't hard as long as you have got a good plan. This is what she says we should do:" +
          "<br><b>1</b> <span class='under_line'>Keep your passports close by!</span> My dad puts all of our passports in his front pocket. " +
          "This way he can get to everything quickly, and he can put them back quickly as well." +
          "<br><b>2</b> <span class='under_line'>Keep snacks and drinks at the top of your luggage!</span> " +
        ...
        "<div class='reading_slide_with_img'>" +
          "<div class='reading_text'>" +
          "<br><b>3</b> <span class='under_line'>Bring everything you need and more!</span> My mum told us that when she and Dad travelled last time, they had some" +
