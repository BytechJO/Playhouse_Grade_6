var snapshot_data = {
  snapshot: [
    {
      audio: [
        "../audios/P32/pizza.mp3",
        "../audios/P32/dough.mp3",
        "../audios/P32/sauce.mp3",
        "../audios/P32/sprinkle.mp3",
        "../audios/P32/cheese.mp3",
        "../audios/P32/add.mp3",
        "../audios/P32/pepperoni.mp3",
        "../audios/P32/slice.mp3",
      ],
      image: [
...
var Popups_data = {
  slides: [
    {
      ...
      listen: {
        ...
        titleIcons: [""],
        titlesAudio: [
          "../audios/P32/Pg4_1.2_Adult_Lady.mp3",
          "../audios/P32/Pg4_1.3_Adult Lady.mp3",
          "../audios/P32/Pg4_1.4_Adult Lady.mp3",
        ],
        image: [
        ...
        words: [
          "<span class='number_bold'>1</span> depart",
          "<span class='number_bold'>2</span> airline",
          "<span class='number_bold'>3</span> flight",
          "<span class='number_bold'>4</span> gate",
          "<span class='number_bold'>5</span> check-in",
          "<span class='number_bold'>6</span> security",
          "<span class='number_bold'>7</span> hand luggage",
          "<span class='number_bold'>8</span> agent",
          "<span class='number_bold'>9</span> e-ticket",
          "<span class='number_bold'>10</span> counter",
          "<span class='number_bold'>11</span> passport",
          "<span class='number_bold'>12</span> boarding card",
        ],
        audio: [
          "../audios/P32/1_depart.mp3",
          "../audios/P32/2_airline.mp3",
          "../audios/P32/3_flight.mp3",
          "../audios/P32/4_gate.mp3",
          "../audios/P32/5_check_in.mp3",
          "../audios/P32/6_security.mp3",
          "../audios/P32/7_hand_luggage.mp3",
          "../audios/P32/8_agent.mp3",
          "../audios/P32/9_e_ticket.mp3",
          "../audios/P32/10_counter.mp3",
          "../audios/P32/11_passport.mp3",
          "../audios/P32/12_boarding_card.mp3",
        ],
      },
      listen2: {
      ...
      listen3: {
        ...
        titleIcons: [""],
        titleTextRight:
          "<span class='blue_text'>Have you ever travelled to another country? Do you enjoy being on an aeroplane?</span>",
  ...
  postions: [
    "left:29.25%; top:25.29%;",
    "left:46.75%; top:20.71%;",
    "left:68.50%; top:11.71%;",
    "left:53.88%; top:35.14%;",
    "left:60.00%; top:47.29%;",
    "left:46.5%; top:45.71%;",
    "left:50.75%; top:57.43%;",
    "left:25.88%; top:89.71%;",
    "left:41.00%; top:70.00%;",
    "left:38.63%; top:85.29%;",
    "left:35.50%; top:92.71%;",
    "left:74.50%; top:73.43%;",
  ],
  imagesAudio: [
    "../audios/P32/1_depart.mp3",
    "../audios/P32/2_airline.mp3",
